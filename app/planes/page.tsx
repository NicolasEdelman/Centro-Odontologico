            ...
            >
              ...
              >
                <div className="bg-[#a5c5e5] p-6 text-white">
                  ...
                  <p className="text-lg opacity-90">
                    Para empresas que buscan beneficios sin cuota mensual
                  </p>
                </div>
                <div className="p-6">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                      Beneficios inmediatos sin costo fijo
                    </p>
                  </div>
                  ...
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-[#7a9cbf] mr-2 flex-shrink-0 mt-0.5" />
                      <span>
                        20% de descuento sobre el arancel de la Asociación
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.97 }}
                  >
                    <Button className="w-full bg-[#7a9cbf] hover:bg-[#5d7a99] text-white">
              ...
              >
                <div className="bg-[#7a9cbf] p-6 text-white">
                  ...
                  <p className="text-lg opacity-90">
                    Cobertura ampliada para empresas exigentes
                  </p>
                </div>
                <div className="p-6">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                      Beneficios extendidos para tus colaboradores
                    </p>
                  </div>
                  ...
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-[#7a9cbf] mr-2 flex-shrink-0 mt-0.5" />
                      <span>
                        35% de descuento sobre el arancel de la Asociación
                        Odontológica Uruguaya
                      </span>
                    </li>
                    <li className="flex items-start text-gray-500">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <motion.div
                ...
                className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 transition-transform"
              >
                <div className="bg-co-secondary-beige p-6 text-white">
                ...
                <div className="p-6">
                  ...
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-co-secondary-beige mr-2 flex-shrink-0 mt-0.5" />
                      <span>Urgencias en horario de consulta</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-co-secondary-beige mr-2 flex-shrink-0 mt-0.5" />
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.97 }}
                  >
                    <Button className="w-full bg-co-secondary-beige hover:bg-co-secondary-brown text-white">
                      Solicitar Información
                    </Button>
                  </motion.div>
                </div>
              ...
              <motion.div
                ...
                className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200 transition-transform"
              >
                <div className="bg-co-secondary-brown p-6 text-white">
                  <h3 className="text-2xl font-bold mb-2">Plan CO Family</h3>
                  <p className="text-lg opacity-90">
                    Cobertura completa para toda la familia
                  </p>
                </div>
                <div className="p-6">
                  <div className="mb-6">
                    ...
                    <p className="text-gray-600">
                      Beneficios extendidos para todos
                    </p>
                  </div>
                  ...
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-co-secondary-brown mr-2 flex-shrink-0 mt-0.5" />
                      <span>Urgencias en horario de consulta</span>
                    </li>
                    <li className="flex items-start">
                      <Check className="h-5 w-5 text-co-secondary-brown mr-2 flex-shrink-0 mt-0.5" />
                  ...
                  <motion.div
                    ...
                    whileTap={{ scale: 0.97 }}
                  >
                    <Button className="w-full bg-co-secondary-brown hover:bg-[#5d7a99] text-white">
                      Solicitar Información
                    </Button>
                  </motion.div>
                </div>
