      ...
      <div className="container mx-auto px-4 z-10">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <a
              href="#contacto"
              className="inline-flex h-12 items-center justify-center rounded-md border border-white bg-transparent px-8 text-base font-medium text-white hover:bg-white/10 transition-colors font-montserrat"
            >
              Agendar Consulta
            </a>
          </div>
