...
export default function DentistProfiles() {
  ...
  return (
    <section id="especialistas" className="w-full bg-co-secondary-beige text-white overflow-hidden relative">
      {/* Imagen de fondo del consultorio */}
      <div className="absolute inset-0 z-0 opacity-40">
        <Image src="/images/consultorio.jpg" alt="Consultorio odontológico" fill className="object-cover" />
      </div>
        ...
        >
          ...
          <div className="grid grid-cols-2 h-full">
            ...
            <div className="relative">
              {/* Imagen de Fabiana */}
              <motion.div variants={itemVariants} className="absolute right-0 bottom-0 h-full w-full">
              ...
              {/* Texto de Fabiana */}
              <motion.div variants={itemVariants} className="absolute left-0 top-[40%] text-left max-w-[320px] pl-4">
                <h3 className="text-3xl md:text-5xl font-bold text-white mb-3">Dra. Fabiana Zelpo</h3>
            ...
            <div className="relative">
              {/* Imagen de Nadia */}
              <motion.div variants={itemVariants} className="absolute left-0 bottom-0 h-full w-full">
                <div className="relative w-full h-full">
                  <Image
              ...
              {/* Texto de Nadia */}
              <motion.div variants={itemVariants} className="absolute right-0 top-[40%] text-right max-w-[320px] pr-4">
                <h3 className="text-3xl md:text-5xl font-bold text-white mb-3">Dra. Nadia Pérez</h3>
                <p className="text-white/90 text-sm md:text-base mb-4">
